...
class Intersecao:
    ...
    def __init__(self, semaforo, monitor_relatorio):                            
        ...
        self.carros_avariados = []                                              # Lista de carros que ficaram avariados
...
class MonitorRelatorio:
    ...
    def exibir_relatorio(self, intersecao):
        """
...
def main():
    ...
    # Exibe o relatório de status da interseção
    monitor_relatorio.exibir_relatorio(intersecao)
